...
jobject nativeSuProfile(JNIEnv *env, jobject /* this */, jstring super_key_jstr, jint uid) {
    ...
    jclass cls = env->FindClass("com/anatdx/icepatch/Natives$Profile");
...
jobject nativeControlKernelPatchModule(JNIEnv *env, jobject /* this */, jstring super_key_jstr, jstring module_name_jstr, jstring control_args_jstr) {
    ...
    jclass cls = env->FindClass("com/anatdx/icepatch/Natives$KPMCtlRes");
    jmethodID constructor = env->GetMethodID(cls, "<init>", "()V");
...
JNIEXPORT jint JNI_OnLoad(JavaVM* vm, void * /*reserved*/) {
    ...
    auto clazz = JNI_FindClass(env, "com/anatdx/icepatch/Natives");
    ...
    const static JNINativeMethod gMethods[] = {
        ...
        {"nativeSuProfile", "(Ljava/lang/String;I)Lcom/anatdx/icepatch/Natives$Profile;", reinterpret_cast<void *>(&nativeSuProfile)},
        ...
        {"nativeControlKernelPatchModule", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/anatdx/icepatch/Natives$KPMCtlRes;", reinterpret_cast<void *>(&nativeControlKernelPatchModule)},
